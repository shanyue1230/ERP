  ...
  <div class="driver">
     ...
     <div class="xf-main">
          ...
          <el-row>
             <el-col :span="5">
              ...
              <el-form-item label="工号:" prop="workersNumber">
                 <el-input v-model="searchForm.workersNumber" placeholder="请输入项目编号">
                 </el-input>
              </el-form-item>
            </el-col>
            <el-col :span="5">
              ...
              <el-col :span="5">
              <!-- 工号 -->
              <el-form-item label="驾照号码:" prop="driverLicense">
                 <el-input v-model="searchForm.driverLicense" placeholder="请输入驾照号码">
                 </el-input>
              </el-form-item>
            </el-col>
      ...
      <el-drawer
          ...
          <el-form-item label="驾照号码:" prop="driverLicense">
                 <el-input type="text" placeholder="请输入驾照号码" v-model="createDriver.driverLicense" @blur="driverLicenseCheck"></el-input>
          </el-form-item>
          <el-form-item label="驾照类型:" prop="licenseType">
             <el-checkbox-group v-model="createDriver.licenseType">
                <el-checkbox label="1">A1</el-checkbox>
                <el-checkbox label="2">A2</el-checkbox>
                <el-checkbox label="3">B1</el-checkbox>
                <el-checkbox label="4">B2</el-checkbox>
                <el-checkbox label="5">C1</el-checkbox>
                <el-checkbox label="6">C2</el-checkbox>
              </el-checkbox-group>
          </el-form-item>
          <el-form-item label="驾照档案号:" prop="fileNumber">
            <el-input type="text" v-model="createDriver.fileNumber" placeholder="请输入驾照档案号" @blur="fileNumberCheck"></el-input>
          </el-form-item>
          <el-form-item label="领证日期:" prop="certificateDate">
                <el-date-picker
                  v-model="createDriver.certificateDate"
                  format="yyyy-MM-dd"
                  value-format="yyyy-MM-dd"
                  type="date"
          ...
          <el-form-item label="有效期:" prop="expirationDate">
               <el-date-picker
                  v-model="createDriver.expirationDate"
                  format="yyyy-MM-dd"
                  value-format="yyyy-MM-dd"
