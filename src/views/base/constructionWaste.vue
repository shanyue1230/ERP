  ...
  <div class="constructionWaste">
     ...
     <div class="xf-main">
      ...
      <el-drawer
          ...
          <el-form-item label="建筑垃圾类型:" prop="companyId">
             <el-select v-model="createDriver.companyId" placeholder="全部">
                  <el-option
                    v-for="item in companyIdList"
                    :key="item.id"
          ...
          <el-form-item label="建造年份:" prop="driverLicense">
                 <el-input type="text" placeholder="请输入建造年份" v-model="createDriver.driverLicense" @blur="driverLicenseCheck"></el-input>
          </el-form-item>
