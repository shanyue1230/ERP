  ...
  <div class="house">
    ...
    <Breadcrumb :levelList="levelList"></Breadcrumb>
              ...
              <el-form :inline="true" :model="form" class="demo-form-inline" ref="searchForm">
                      <el-row>
                        <el-col :span="5" style="padding:0">
                          <el-form-item label="垃圾箱房名称：" prop="name">
                            <el-input type="text" placeholder="请输入垃圾厢房名称" v-model="form.name"></el-input>
                          </el-form-item>
                        </el-col>
                        <el-col :span="5" style="padding:0">
                        ...
                        <el-col  style="padding:0; width:280px;">
                          ...
                          >
                            <el-button type="primary" @click="researchGarbageRoom">确定</el-button>
                    ...
                    <el-row v-if="show">
                      <el-col :span="5" style="padding:0">
                        <el-form-item label="所属物业：" prop="propertyId">
                          <el-select v-model="form.propertyId" placeholder="全部">
                            <el-option
                      ...
                      <el-col :span="5" style="padding:0;">
                         <el-form-item label="所属小区：" style="margin-left:16px" prop="communityId">
                          <el-select v-model="form.communityId" placeholder="全部">
                            <el-option
                      ...
                      <el-col :span="5" style="padding:0;">
                         <el-form-item label="是否设置区域：" style="margin-left:16px" prop="isSetArea">
       ...
       <el-table :data="tableData" style="width: 100%;margin-top:16px">
        ...
        <el-table-column prop="name" label="垃圾箱房名称"></el-table-column>
        ...
        <el-table-column label="操作" width="200">
          <template slot-scope="{row}">
               <span v-show="currentCompanyIds.indexOf(row.companyId) !== -1 && privilegeCodes.indexOf('basic:garbageRoom:edit') !== -1" class="span" @click="isEdit(row.id)">编辑</span>&nbsp;&nbsp;
               <span style="color:#ccc">|</span>&nbsp;&nbsp;
               <span class="span" @click="isDetails(row.id)">查看详情</span>&nbsp;&nbsp;
               <span style="color:#ccc">|</span>&nbsp;&nbsp;
               <span class="span" v-show="currentCompanyIds.indexOf(row.companyId) !== -1 && privilegeCodes.indexOf('basic:garbageRoom:location') !== -1" @click="isPosition(row.id)">定位</span>&nbsp;&nbsp;
               <span style="color:#ccc">|</span>&nbsp;&nbsp;
               <span v-show="currentCompanyIds.indexOf(row.companyId) !== -1 && privilegeCodes.indexOf('basic:garbageRoom:delete') !== -1" class="span" @click="showDeleteDrawer(row.id)">删除</span>
          </template>
        </el-table-column>
      </el-table>
              <!-- 分页器 -->
       ...
       <!-- 新增的抽屉框 -->
          <el-drawer
            ...
            <el-form class="scorllform"   :model="drawerForm"  :rules="rules" ref="createDrawerForm">
              <el-row :gutter="30">
                <el-col :span="12">
              ...
              <!-- ------------ -->
                ...
                <el-col :span="12">
                       <el-form-item label="垃圾箱房名称：" prop="name">
                          <el-input v-model="drawerForm.name" placeholder="请输入垃圾箱房名称"></el-input>
                      </el-form-item>
                  </el-col>
                  <el-col  :span="12">
               ...
               <!-- ------------ -->
                ...
                <el-col :span="12">
                       <el-form-item label="所属物业：" prop="propertyId">
                                          <el-select v-model="drawerForm.propertyId" placeholder="全部">
                                                <el-option
                                                  v-for="item in propertyList"
                                                  :key="item.id"
                                                  :label="item.name"
                  ...
                  <el-col  :span="12">
                      <el-form-item label="所属小区："  prop="communityId">
                                        <el-select v-model="drawerForm.communityId" placeholder="全部">
                                                <el-option
                                                  v-for="item in communityList"
                                                  :key="item.id"
                                                  :label="item.name"
                ...
                <el-row  :gutter="30">
                <el-col :span="12">
                       <el-form-item label="交付点No.：" prop="deliveryPointCode">
                          <el-input v-model="drawerForm.deliveryPointCode" placeholder="请输入交付点No"></el-input>
                      </el-form-item>
                  </el-col>
                  <el-col  :span="12">
                      <el-form-item label="点位No.：" prop="pointCode">
                        <el-input v-model="drawerForm.pointCode" placeholder="请输入点位No"></el-input>
                      </el-form-item>
                </el-col>
              </el-row>
             <!-- ------------ -->
                <el-row  :gutter="30">
                <el-col :span="12">
                       <el-form-item label="点位类型  ：" prop="pointTypeList">
                                         <!-- <el-select v-model="drawerForm.pointTypeList" placeholder="全部">
                                                <el-option
                                        ...
                                        <el-checkbox-group v-model="drawerForm.pointTypeList">
                                          <el-checkbox label="绿色账户"></el-checkbox>
                                          <el-checkbox label="两网融合"></el-checkbox>
                                        </el-checkbox-group>
                      </el-form-item>
                  </el-col>
                  <el-col  :span="12">
              ...
              <el-row>
                ...
                <div class="saveAndCancle">
                       <el-button @click="newDrawer=false">取 消</el-button>
                        <el-button type="primary" @click="createGarbageRoom">确 定</el-button>
                </div>
          </el-drawer>
        <!-- 编辑的抽屉框 -->
          <el-drawer
            ...
            :before-close="handleClose">
                  <el-form   :model="drawerForm"  :rules="rules" class="scorllform">
                    <el-row :gutter="30">
                      <el-col :span="12">
                             <el-form-item label="所属单位：" prop="companyId">
                                  <el-select v-model="drawerForm.companyId" placeholder="全部">
                ...
                <div class="saveAndCancle">
                       ...
                       <el-button type="primary" @click="eidtDone">确 定</el-button>
                </div>
          </el-drawer>
        <!-- 查看详情的抽屉框 -->
           <el-drawer
            ...
            :before-close="handleClose">
                    <el-row style="height:100%;padding:31px">
                               <el-col :span="12" style="height:100%">
                                  <div class="info">
                                    <el-form style="padding:0" :model="drawerForm" class="scorllform">
                                      ...
                                      <el-form-item  label="垃圾厢房名称">{{drawerForm.name}}</el-form-item>
                                      <el-form-item  label="地址">{{drawerForm.address}}</el-form-item>
                                      <el-form-item  label="所属物业">{{drawerForm.propertyName}}</el-form-item>
                                      <el-form-item  label="所属小区">{{drawerForm.communityName}}</el-form-item>
                                      <el-form-item  label="交付点No.">{{drawerForm.deliveryPointCode}}</el-form-item>
                                      <el-form-item  label="点位No.">{{drawerForm.pointCode}}</el-form-item>
                                      <el-form-item  label="点位类型">{{drawerForm.pointType}}</el-form-item>
...
import { getDataFilter, garbageRoomSharedList, childCompanyList, getRegionLocale, employeeListing, communityList, propertyList, garbageRoomAdd, garbageRoomDelete, garbageRoomView, garbageRoomEdit, dataDictItem, garbageRoomExport, garbageRoomLocaion } from '../../api/getData'
import axios from 'axios'
export default {
  data () {
    const self = this;
    return {
      levelList: [{ title: '环卫设施点' }, { title: '垃圾箱房' }],
      ...
      rules: {
        ...
        name: [
          { required: true, message: '请输入垃圾厢房名称', trigger: 'blur' }
        ],
        address: [
          { required: true, message: '请输入地址', trigger: 'blur' }
        ],
        propertyId: [
          { required: true, message: '请选择物业', trigger: ['blur', 'change'] }
        ],
        communityId: [
  ...
  methods: {
    ...
    eidtDone () {
      ...
      garbageRoomEdit(data).then(res => {
        if (res.data.code === 200) {
          this.editDrawer = false
          this.getGarbageRoomList()
    ...
    isNewDrawer () {
      this.newDrawer = true
      this.$nextTick(() => {
        this.$refs.createDrawerForm.resetFields()
      })
    ...
    async fn () {
      ...
      const res6 = await communityList(data6)
      this.communityList = res6.data.data
      ...
      const res7 = await propertyList(data7)
      console.log(res7);
      this.propertyList = res7.data.data
    ...
    getGarbageRoomList () {
      ...
      garbageRoomSharedList(data).then(res => {
        console.log(res);
        if (res.data.code === 200) {
    ...
    querySearch (queryString, cb) {
      var restaurants = this.peopleRestaurants;
    ...
    createGarbageRoom () {
      console.log(this.drawerForm);
      // 表单校验
      this.$refs.createDrawerForm.validate(valid => {
        if (valid) {
          this.drawerForm.regionLocaleId = this.drawerForm.regionLocaleId.pop()
