...
import { stationDeviceList, stationDeviceAdd, companyAdd, stationDeviceValid, stationDeviceDelete, stationDeviceEnable, stationDeviceDisable, stationDeviceView, dataDictItem, stationDeviceEdit, stationDeviceExport } from '../../api/getData'
export default {
  data () {
