<template>
  <div class="toilet">
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item>公厕</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="xf-main">
      <div class="xf-left">
      ...
      <div class="xf-right">
          ...
          <el-row>
            <el-col :span="5">
              ...
              <el-form-item label="公厕名称:" prop="name">
                <el-input v-model="listQuery.name" placeholder="请输入公厕名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="5">
              <!-- 所属单位 -->
              ...
              <!-- 是否设置区域 -->
                <el-form-item label="是否设置区域:" prop="deptId">
                  <el-select v-model="listQuery.markerStatus" placeholder="全部">
                    <el-option
        ...
        <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" height="65%">
          ...
          <el-table-column prop="committee" label="所属居委会"></el-table-column>
          <el-table-column prop="name" label="公厕名称"></el-table-column>
          <el-table-column prop="typeName" label="公厕类型"></el-table-column>
        ...
        >
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="公厕名称" prop="name">
                  <el-input type="text" placeholder="请输入公厕名称" v-model="form.name"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="居委会" prop="committee">
                  <el-input type="text" placeholder="请输入居委会" v-model="form.committee"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <!-- -------------- -->
            <el-row>
              <el-col :span="12">
                <el-form-item label="公厕编号" prop="no">
                  <el-input type="text" placeholder="请输入公厕编号" v-model="form.no"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="公厕类型" prop="type">
                  <el-select v-model="form.type" placeholder="请选择公厕类型">
                    <el-option
                    v-for="item in toiletTypeList"
                    :key="item.value"
                    :label="item.name"
                    :value="item.value"
                    ></el-option>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="级别" prop="level">
                  <el-input type="text" placeholder="请输入级别" v-model="form.level"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="水冲方式" prop="flushWater">
                  <el-select v-model="form.flushWater" placeholder="请选择水冲方式">
                    <el-option
                    v-for="item in toiletFlushWaterList"
                    :key="item.value"
                    :label="item.name"
                    :value="item.value"
                    ></el-option>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="男蹲位数量" prop="manPitCount">
                  <el-input-number v-model="form.manPitCount" :min="0" style="width:100%;"></el-input-number>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="男站位数量" prop="manStandCount">
                  <el-input-number v-model="form.manStandCount" :min="0" style="width:100%;"></el-input-number>
                </el-form-item>
              </el-col>
            </el-row>
            <!-- -------------- -->
            <el-row>
              <el-col :span="12">
                <el-form-item label="女蹲位数量" prop="womanPitCount">
                  <el-input-number v-model="form.manPitCount" :min="0" style="width:100%;"></el-input-number>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="女站位数量" prop="womanStandCount">
                  <el-input-number v-model="form.manStandCount" :min="0" style="width:100%;"></el-input-number>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="残疾设备" prop="isDisabilityEquipment">
                  <el-radio-group v-model="form.isDisabilityEquipment">
              ...
              <el-col :span="12">
                <el-form-item label="室内导向设备" prop="isGuideEquipment">
                  <el-radio-group v-model="form.isGuideEquipment">
                    <el-radio :label='true'>有</el-radio>
                    <el-radio :label='false'>无</el-radio>
                 </el-radio-group>
                </el-form-item>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="收费许可证" prop="isFeeLicense">
                  <el-radio-group v-model="form.isFeeLicense">
                    <el-radio :label='true'>有</el-radio>
                    <el-radio :label='false'>无</el-radio>
                 </el-radio-group>
                </el-form-item>
              ...
              <el-col :span="12">
                <el-form-item label="作业单位" prop="cleaningCompany">
                  <el-input type="text" placeholder="请输入作业单位" v-model="form.cleaningCompany"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <!-- -------------- -->
            <el-row>
              <el-col :span="12">
                <el-form-item label="管理单位" prop="isFeeLicense">
                  <el-input type="text" placeholder="请输入管理单位" v-model="form.manageCompany"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="实际收费" prop="fee">
                  <el-input-number v-model="form.fee" :min="0" style="width:100%;"></el-input-number>
                </el-form-item>
              </el-col>
            </el-row>
            <!-- -------------- -->
            <el-row>
              <el-col :span="12">
                <el-form-item label="联系人" prop="contact">
                  <el-input type="text" placeholder="请输入联系人" v-model="form.contact"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
                            ...
                            <el-col :span="12" style="height:100%">
                                <div class="info">
                                  <el-form style="padding:0" :model="form" >
                                    ...
                                    <el-form-item  label="所属街道">{{form.streetName}}</el-form-item>
                                    <el-form-item  label="公厕名称">{{form.name}}</el-form-item>
                                    <el-form-item  label="居委会">{{form.committee}}</el-form-item>
                                    <el-form-item  label="公厕编号">{{form.no}}</el-form-item>
                                    <el-form-item  label="地址">{{form.address}}</el-form-item>
                                    <el-form-item  label="建造日期">{{form.buildDate}}</el-form-item>
                                    <el-form-item  label="公厕类型">{{form.typeName}}</el-form-item>
                                    <el-form-item  label="级别">{{form.level}}</el-form-item>
                                    <el-form-item  label="水冲方式">{{form.flushWaterName}}</el-form-item>
                                    <el-form-item  label="男蹲位数量">{{form.manPitCount}}</el-form-item>
                                    <el-form-item  label="男站位数量">{{form.manStandCount}}</el-form-item>
                                    <el-form-item  label="女蹲位数量">{{form.womanPitCount}}</el-form-item>
                                    <el-form-item  label="女站位数量">{{form.womanStandCount}}</el-form-item>
                                    <el-form-item  label="开放时间">{{form.openTime}}</el-form-item>
                                    <el-form-item  label="关闭时间">{{form.closeTime}}</el-form-item>
                                    <el-form-item  label="残疾设备">{{form.isDisabilityEquipment === true ? "有" : "无"}}</el-form-item>
                                    <el-form-item  label="室内导向设备">{{form.isGuideEquipment === true ? "有" : "无"}}</el-form-item>
                                    <el-form-item  label="收费许可证">{{form.isFeeLicense === true ? "有" : "无"}}</el-form-item>
                                    <el-form-item  label="作业单位">{{form.cleaningCompany}}</el-form-item>
                                    <el-form-item  label="管理单位">{{form.manageCompany}}</el-form-item>
                                    <el-form-item  label="实际收费">{{form.fee}}</el-form-item>
...
import { getDataFilter, companyList, getRegionLocale, toiletList, employeeListing, toiletAdd, toiletView, toiletEdit, dataDictItem, toiletDelete, toiletPosition, toiletExport, dictItem } from '../../api/getData';
export default {
  data () {
    return {
      positionOptions: [
      ...
      tableData: [
        {
          'creator': '燕震华',
          'createTime': '2020-01-20 15:47:09',
          'creatorId': 22,
          'updater': 'yanzhenghua',
          'updaterId': 22,
          'updateTime': '2020-01-20 16:11:41',
          'isDelete': false,
          'id': 2,
          'companyId': 1,
          'districtId': null,
          ...
          'openTime': '05:30:00',
          'closeTime': '21:00:00',
          'isDisabilityEquipment': false,
          'isGuideEquipment': false,
          'isFeeLicense': false,
          'cleaningCompany': '保洁单位名称',
          'manageCompany': '管理单位名称',
          'contact': '张三',
          'fee': null,
          'longitude': null,
          'latitude': null,
      ...
      form: {
        ...
        type: undefined,
        level: undefined,
        flushWater: undefined,
        manPitCount: undefined,
        manStandCount: undefined,
        womanPitCount: undefined,
        womanStandCount: undefined,
        constructionArea: undefined,
        openTime: undefined,
        closeTime: undefined,
        isDisabilityEquipment: true,
        isGuideEquipment: undefined,
        isFeeLicense: undefined,
        cleaningCompany: undefined,
      ...
      rules: {
        ...
        name: [
          { required: true, message: '请填写公厕名称', trigger: 'blur' }
        ],
        address: [
          { required: true, message: '请填写公厕地址', trigger: 'blur' }
        ],
        no: [
          { required: true, message: '请填写公厕编号', trigger: 'blur' }
        ],
        buildDate: [
          { required: true, message: '请填写建造日期', trigger: 'blur' }
        ],
        type: [
          { required: true, message: '请选择公厕类型', trigger: 'blur' }
        ],
        level: [
          { required: true, message: '请填写公厕级别', trigger: 'blur' }
        ],
        flushWater: [
          { required: true, message: '请填选择水冲方式', trigger: 'blur' }
        ]
      },
      positionForm: {
        address: '',
  ...
  methods: {
    ...
    async init () {
      ...
      this.getToiletTypeList();
      this.getToiletFlushWaterList();
    },
    /**
     * 每页条数改变
     */
    ...
    resetSearchForm () {
      ...
      this.listQuery.markerStatus = undefined;
    },
    /**
     * 获取数据过滤器单位列表
     */
     ...
     */
    getList () {
      toiletList(this.listQuery).then(res => {
        if (res.status === 200) {
          if (res.data.code === 200) {
     ...
     */
    getToiletTypeList () {
      dictItem({ code: 'toiletType', showSelectOption: false }).then(res => {
        if (res.status === 200) {
          if (res.data.code === 200) {
            this.toiletTypeList = res.data.data;
          } else {
            this.$message.error(res.data.msg);
          }
        }
     ...
     * 获取水冲方式列表
     */
    getToiletFlushWaterList () {
      dictItem({ code: 'toiletFlushWater', showSelectOption: false }).then(res => {
        if (res.status === 200) {
          if (res.data.code === 200) {
            this.toiletFlushWaterList = res.data.data;
          } else {
            this.$message.error(res.data.msg);
          }
        }
    ...
    addFormData () {
      ...
      this.$refs.ruleForm.validate(valid => {
        if (valid) {
          if (this.form.streetId instanceof Array) { this.form.streetId = this.form.streetId.pop(); }
          toiletAdd(this.form).then(res => {
            if (res.data.code === 200) {
              this.getList();
