                    ...
                    <el-row v-if="show">
                      <el-col :span="5" style="padding:0">
                        <el-form-item label="所属物业：">
                          <el-select v-model="form.property" placeholder="全部">
                            <el-option
                      ...
                      <el-col :span="5" style="padding:0;">
                         <el-form-item label="所属小区：" style="margin-left:16px">
                          <el-select v-model="form.plot" placeholder="全部">
                            <el-option
                              v-for="item in options4"
                              :key="item.value"
                              :label="item.label"
                      ...
                      <el-col :span="5" style="padding:0;">
                         <el-form-item label="是否设置区域：" style="margin-left:16px">
            ...
            <el-form   :model="drawerForm"  :rules="rules">
              ...
              <!-- ------------ -->
               ...
               <!-- ------------ -->
                <el-row  :gutter="30">
                <el-col :span="12">
                       <el-form-item label="所属物业：" prop="property">
                                          <el-select v-model="drawerForm.property" placeholder="全部">
                                                <el-option
                  ...
                  <el-col  :span="12">
                      <el-form-item label="所属小区："  prop="plot">
                                        <el-select v-model="drawerForm.plot" placeholder="全部">
                                                <el-option
                ...
                <el-row  :gutter="30">
                <el-col :span="12">
                       <el-form-item label="交付点No.：" prop="delivery">
                          <el-input v-model="drawerForm.delivery" placeholder="请输入交付点No"></el-input>
                      </el-form-item>
                  </el-col>
                  <el-col  :span="12">
                      <el-form-item label="点位No.：" prop="point">
                        <el-input v-model="drawerForm.point" placeholder="请输入点位No"></el-input>
                      </el-form-item>
                </el-col>
              </el-row>
             <!-- ------------ -->
                <el-row  :gutter="30">
                <el-col :span="12">
                       <el-form-item label="点位类型  ：" prop="delivery">
                                         <el-select v-model="drawerForm.plotType" placeholder="全部">
                                                <el-option
