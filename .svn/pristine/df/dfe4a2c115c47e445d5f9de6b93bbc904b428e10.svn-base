        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="所属单位：" prop="unit">
              <el-select v-model="ruleFormEdit.unit" filterable placeholder="请选择所属单位"   @change="resetForm2('ruleForm')">
                <el-option
...
import { vehicleDeviceAdd, vehicleDeviceList, vehicleDeviceDelete, vehicleDeviceEnable, vehicleDeviceDisable, companyAdd, dataDictItem, vehicleDeviceEdit, vehicleDeviceView, vehicleDeviceValid, vehicleDeviceExport } from '../../api/getData'
export default {
  data () {
