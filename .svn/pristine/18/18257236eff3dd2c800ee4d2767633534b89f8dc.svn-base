      ...
      <div class="xf-right">
        ...
        >
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="道班房名称" prop="name">
                  <el-input type="text" placeholder="请输入道班房名称" v-model="form.name"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                            ...
                            <el-col :span="12" style="height:100%">
                                <div class="info">
                                  <el-form style="padding:0" :model="form" >
                                    ...
                                    <el-form-item  label="道班房转站名称">{{form.name}}</el-form-item>
...
import { getDataFilter, companyList, getRegionLocale, loungeList, employeeListing, loungeAdd, loungeView, loungeEdit, dataDictItem, loungeDelete, loungePosition, loungeExport } from '../../api/getData';
export default {
  data () {
    return {
      positionOptions: [
      ...
      rules: {
        ...
        name: [
          { required: true, message: '请填写道班房名称', trigger: 'blur' }
        ],
        address: [
          { required: true, message: '请填写道班房地址', trigger: 'blur' }
        ]
      },
      positionForm: {
        address: '',
  ...
  methods: {
     ...
     */
    getList () {
      loungeList(this.listQuery).then(res => {
        if (res.status === 200) {
          if (res.data.code === 200) {
