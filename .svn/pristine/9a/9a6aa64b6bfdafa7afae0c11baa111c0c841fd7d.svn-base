  ...
  <div class="vehicleDevice">
    ...
    <div class="main">
      ...
      <div class="affiliationInfo">
        ...
        >
          ...
          <el-table-column prop="stationId" label="所属小压站"></el-table-column>
          <el-table-column prop="type" label="设备类型"></el-table-column>
          <el-table-column prop="useDate" label="安装日期"></el-table-column>
          <el-table-column prop="expiryDate" label="维保到期日" width="150px"></el-table-column>
    ...
    >
      ...
      >
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="所属单位：" prop="unit" >
              <el-select v-model="ruleForm.unit"  filterable   placeholder="请选择所属单位"   @change="resetForm2('ruleForm')">
                <el-option
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="所属小压站：" prop="station">
              <el-select v-model="ruleForm.station" placeholder="请选择所属小压站">
                <el-option
      ...
      <div slot="footer" class="dialog-footer" style="text-align: center">
        ...
        <el-button type="primary" @click="isStationAdd('ruleForm')">确 定</el-button>
      </div>
    </el-dialog>
    <!-- 查看详情的对话框 -->
                               ...
                               <el-col :span="12" style="height:100%">
                                  <div class="info">
                                    <el-form>
                                      ...
                                      <el-form-item  label="所属小压站">{{viewList.stationId}}</el-form-item>
    ...
    >
      ...
      >
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="所属单位：" prop="unit" >
              <el-select v-model="ruleFormEdit.unit" placeholder="请选择所属单位"   @change="resetForm2('ruleFormEdit')">
                <el-option
                  v-for="item in options2"
                  :key="item.id"
                  :label="item.name"
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="所属小压站：" prop="station">
              <el-select v-model="ruleFormEdit.station" placeholder="请选择所属小压站">
                <el-option
                  v-for="item in options3"
                  :key="item.value"
                  :label="item.label"
...
import { stationDeviceList, stationDeviceAdd, companyAdd, stationDeviceValid, stationDeviceDelete, stationDeviceEnable, stationDeviceDisable, stationDeviceView, dataDictItem, stationDeviceEdit, stationDeviceExport, companyList } from '../../api/getData'
export default {
  data () {
    ...
    return {
      ...
      viewList2: '',
      multipleSelection: [],
      levelList: [{ title: '设备管理' }, { title: '小压站设备管理' }],
      formInline: {
        unit: '',
        checkList: []
      },
      ...
      rules: {
        ...
        station: [
          { required: true, message: '请选择所属小压站', trigger: 'blur' }
        ],
        status: [
  ...
  methods: {
    ...
    isDetails (row) {
      ...
      stationDeviceView(row).then(res => {
        console.log(res);
    ...
    // 新增功能接口
    isStationAdd (formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          return stationDeviceAdd(
            {
              'companyId': this.ruleForm.unit,
              'stationId': this.ruleForm.station,
    ...
    // 小压站设备编辑
    isVehicleDeviceEdit () {
      return stationDeviceEdit(
        {
          'id': this.rowList.id,
          'companyId': this.ruleFormEdit.unit,
          'stationId': this.ruleFormEdit.station,
    ...
    // 查询功能
    isInquire () {
      // console.log(this.form.value3[0], this.form.value3[1], this.form.value4);
      return stationDeviceList({
        'page': this.pageNumber,
        'limit': this.pageSize,
        'projectCode': this.form.num1,
    ...
    export2Excel () {
      import('../../assets/js/Export2Excel').then(excel => {
        const tHeader = ['设备编号', '所属小压站', '设备类型', '安装日期', '维保到期日', '状态']
        const filterVal = ['code', 'stationId', 'type', 'useDate', 'expiryDate', 'statusName']
