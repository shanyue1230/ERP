...
import { stationDeviceView, dataDictItem, stationDeviceExport, getDataFilter, stationDeviceSharedList } from '../../api/getData'
export default {
  data () {
    return {
      show: false,
  ...
  created () {
    this.isStationDeviceSharedList()
  ...
  methods: {
    ...
    // 获取表格列表
    isStationDeviceSharedList () {
      return stationDeviceSharedList({
